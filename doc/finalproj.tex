...
\begin{abstract}
%\boldmath
This project proposes to implement a system that finds all relevant images for a given query image in videos, hence 
...
However, for a given 
Motivated by the needs to search through large amount of surveillance videos for interesting objects, 
\cite{sivic2003video}

\section{Algorithm}
For feature detection, only Shape-Adapted regions are considered in this work. Maximally Stable (MS) regions 
