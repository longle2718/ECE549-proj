...
The details are given in Section \ref{sec:alg}. The performance of the system is shown in Section \ref{sec:perf}. Finally, discussion about the final system
performance in relation with its algorithm are given in Section {sec:concl}.

\section{Algorithm}
\label{sec:alg}
The outline of an algorithm for Video Google

For feature detection, only Shape-Adapted regions are considered in this work. Maximally Stable (MS) regions \cite{vedaldi08vlfeat}.
