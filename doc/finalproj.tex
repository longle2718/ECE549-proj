...
the detail implementation information is not available. In this project, a (potentially different) tracking mechanism is proposed, based on our own 
...
their descriptors, extracted independently from the previous step, is formed. An element inside the matrix that is greater than 
...
The {\it vl\_covdet} with the flag {\it 'EstimateAffineShape'} set to true.
